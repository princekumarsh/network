...
@section('content')
        ...
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="banner-container bg-overlay bg_img"
                    data-background="https://script.viserlab.com/mlmlab/assets/images/frontend/banner/636a0148129cb1667891528.jpg">
                    <div class="container">
                        <div class="banner-content">
                            <h3 class="sub-title">MLMLab</h3>
                            <h1 class="title">Multilevel Marketing Platform</h1>
                            <div class="button-area">
                                <p>We are a dedicated Binary Multilevel Marketing company for every MLM plan with custom
                                    features.</p>
                                <div class="button-group">
                                    <a class="custom-button active" href="{{route('login')}}">Log In</a>
                                    <a class="custom-button" href="{{route('register')}}">Register</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="swiper-slide">
                <div class="banner-container bg-overlay bg_img"
                    data-background="https://script.viserlab.com/mlmlab/assets/images/frontend/banner/636a01142c5ef1667891476.jpg">
                    <div class="container">
                        <div class="banner-content">
                            <h3 class="sub-title">MLMLab</h3>
                            <h1 class="title">Multilevel Marketing Platform</h1>
            ...
            <div class="row justify-content-between mb--50 flex-wrap-reverse">
                <div class="col-lg-6 pe-xl-5 mb-50">
                    <div class="video-wrapper w-100 h-100 bg-overlay bg_img"
                        data-background="https://script.viserlab.com/mlmlab/assets/images/frontend/about/636a056cba46f1667892588.jpg">
                        <a class="video-button popup" href="https://www.youtube.com/watch?v=WOb4cj7izpE">
                ...
                <div class="col-lg-6 mb-50">
                    <div class="about-content">
                        ...
                        <p> We are not just an online version of any Business market, but also, the reflection of each
                            and every MLM business. We are an international financial company engaged in investment
                            activities, which are related to MLM on financial markets by qualified professional traders.
                        </p>
            ...
            <div class="row justify-content-center mb-30-none">
                <div class="col-xl-4 col-md-6 col-sm-10">
                    <div class="feature-item">
                        ...
                        <div class="feature-body">
                            <p>Just click the register button on the website and fill up all the information there and
                                get your account.</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6 col-sm-10">
                    <div class="feature-item">
                        ...
                        <div class="feature-body">
                            <p>The strategy is new members sponsored by distributors are added either on the left or
                                right leg.</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6 col-sm-10">
                    <div class="feature-item">
                        ...
                        <div class="feature-body">
                            <p>Each member will get a commission by adding a new member. So it&#039;s a profitable
                                process for all.</p>
                        </div>
                    </div>
                </div>
    ...
    <section class="team-section padding-top padding-bottom section-bg">
        <div class="container">
            <div class="section-header">
                ...
                <p>The company empowers our team members to impact the company mission, grow personally and
                    professionally, and reach an optimal work-life balance. So, meet with our awesome members!</p>
            </div>
            <div class="row justify-content-center mb-30-none">
                <div class="col-lg-3 col-md-6 col-sm-9">
                    <div class="team-item">
                        <div class="team-thumb">
                            <img src="https://script.viserlab.com/mlmlab/assets/images/frontend/team/636a162adadcc1667896874.jpg"
                                alt="team">
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-9">
                    <div class="team-item">
                        <div class="team-thumb">
                            <img src="https://script.viserlab.com/mlmlab/assets/images/frontend/team/636a1601368b21667896833.jpg"
                                alt="team">
                        </div>
                        <div class="team-content">
                            <h6 class="title">
                ...
                <div class="col-lg-3 col-md-6 col-sm-9">
                    <div class="team-item">
                        <div class="team-thumb">
                            <img src="https://script.viserlab.com/mlmlab/assets/images/frontend/team/636a15e0139101667896800.jpg"
                                alt="team">
                        </div>
                        <div class="team-content">
                            <h6 class="title">
                ...
                <div class="col-lg-3 col-md-6 col-sm-9">
                    <div class="team-item">
                        <div class="team-thumb">
                            <img src="https://script.viserlab.com/mlmlab/assets/images/frontend/team/636a15b788b3b1667896759.jpg"
                                alt="team">
                        </div>
                        <div class="team-content">
                            <h6 class="title">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-header">
                        ...
                        <p>At this website, making deposits and widthway is simple and straight forward and hardly takes
                            up any of your time. We are constantly striving to offer you, even more, deposit and
                            withdraw options and to make the process even easier.</p>
                    </div>
                </div>
            </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="author">
                                                ...
                                                <div class="content">bskhgfdhjv,cxjb ghdfksdgljh</div>
                                            </div>
                                        </td>
                                        <td>
                                            No plan</td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="author">
                                                ...
                                                <div class="content">Faisal Ali</div>
                                            </div>
                                        </td>
                                        <td>
                                            No plan</td>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="author">
                                                <div class="thumb">
                                                    <img src="https://script.viserlab.com/mlmlab/assets/images/user/profile/6457a10e658e91683464462.jpg"
                                                        alt="jpg">
                                                </div>
                                                <div class="content">
                                                    Hedley User
    ...
    <div class="counter-section padding-top padding-bottom bg-overlay bg_fixed bg_img"
        data-background="https://script.viserlab.com/mlmlab/assets/images/frontend/counter/638219f1423511669470705.jpg">
        <div class="container">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="client-item">
                            <blockquote>
                                Lorem Ipsum Dolor Sit Amet, Consectetur Adipisicing Elit. Alias Est Maiores Quo Tempora
                                Illum Quibusdam, Incidunt Aspernatur, Voluptatem Maxime!
                            </blockquote>
                            <div class="author">
                                <div class="author-thumb">
                                    <img src="https://script.viserlab.com/mlmlab/assets/images/frontend/testimonial/636a185cb4d031667897436.jpg"
                                        alt="client">
                                </div>
                    ...
                    <div class="swiper-slide">
                        <div class="client-item">
                            ...
                            <div class="author">
                                <div class="author-thumb">
                                    <img src="https://script.viserlab.com/mlmlab/assets/images/frontend/testimonial/636a184006d401667897408.jpg"
                                        alt="client">
                                </div>
                                <div class="author-content">
                    ...
                    <div class="swiper-slide">
                        <div class="client-item">
                            ...
                            <div class="author">
                                <div class="author-thumb">
                                    <img src="https://script.viserlab.com/mlmlab/assets/images/frontend/testimonial/636a1812bede71667897362.jpg"
                                        alt="client">
                                </div>
                                <div class="author-content">
                    ...
                    <div class="swiper-slide">
                        <div class="client-item">
                            ...
                            <div class="author">
                                <div class="author-thumb">
                                    <img src="https://script.viserlab.com/mlmlab/assets/images/frontend/testimonial/636a188290b771667897474.png"
                                        alt="client">
                                </div>
                                <div class="author-content">
    ...
    <section class="subscribe-section padding-top padding-bottom bg-overlay bg_img bg_fixed" id="subscribe"
        data-background="https://script.viserlab.com/mlmlab/assets/images/frontend/subscribe/636a1a31517241667897905.jpg">
        <div class="container">
                ...
                <div class="col-lg-8">
                    <div class="subscribe-content">
                        ...
                        <form class="subscribe-form" method="post"
                            action="https://script.viserlab.com/mlmlab/subscriber">
                            <input type="hidden" name="_token" value="VBr7qUXJbsQNhR3Hmfb7AARaJtQtKPxLLmRUGtJm"> <input
                                name="email" type="email" id="email" placeholder="Enter Your email address" required>
                            <button type="submit">
            ...
            <div class="row mb-30-none">
                <div class="col-md-6 col-xl-4 col-sm-10">
                    <div class="post-item">
                        <div class="post-thumb c-thumb">
                            <a href="{{route('blog1')}}">
                                <img src="https://script.viserlab.com/mlmlab/assets/images/frontend/blog/thumb_6381ec415660a1669459009.jpg"
                                    alt="blog">
                            </a>
                        </div>
                        <div class="post-content">
                            <h5 class="title">
                                <a
                                    href="https://script.viserlab.com/mlmlab/blog/77/2022-top-50-mlm-companies-in-the-us">2022
                                    Top 50 MLM Companies in the U.S.</a>
                            </h5>
                            <ul class="meta-post">
                            ...
                            <div class="entry-content">
                                <p>*Note: 2019 revenue numbers coming soon.Below is the comprehensive list of
                                    multi-level marketing companies generating the most amount of revenue in the United
                                    States...</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-xl-4 col-sm-10">
                    <div class="post-item">
                        <div class="post-thumb c-thumb">
                            <a
                                href="https://script.viserlab.com/mlmlab/blog/76/amway-co-founder-richard-devos-passes-away-at-age-92">
                                <img src="https://script.viserlab.com/mlmlab/assets/images/frontend/blog/thumb_6381eae20f24c1669458658.png"
                                    alt="blog">
                            </a>
                        </div>
                        <div class="post-content">
                            <h5 class="title">
                                <a
                                    href="https://script.viserlab.com/mlmlab/blog/76/amway-co-founder-richard-devos-passes-away-at-age-92">Amway
                                    Co-Founder Richard DeVos Passes Away at Age 92</a>
                            </h5>
                            <ul class="meta-post">
                                <li><i class="fas fa-calendar-day"></i><span>08 Nov, 2022</span>
                                </li>
                            ...
                            <div class="entry-content">
                                <p>Rick DeVos announced earlier today that his grandfather and co-founder of Amway
                                    Richard DeVos has passed away at age 92. DeVos got his start in the multi-level
                                    marke...</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-xl-4 col-sm-10">
                    <div class="post-item">
                        <div class="post-thumb c-thumb">
                            <a
                                href="https://script.viserlab.com/mlmlab/blog/75/melaleuca-ceo-frank-vandersloot-promises-to-resign-if-world-record-attempt-fails">
                                <img src="https://script.viserlab.com/mlmlab/assets/images/frontend/blog/thumb_6381eaebb1e881669458667.png"
                                    alt="blog">
                            </a>
                        </div>
                        <div class="post-content">
                            <h5 class="title">
                                <a
                                    href="https://script.viserlab.com/mlmlab/blog/75/melaleuca-ceo-frank-vandersloot-promises-to-resign-if-world-record-attempt-fails">Melaleuca
                                    CEO Frank VanderSloot Promises to Resign if World Record Attempt Fails</a>
                            </h5>
                            <ul class="meta-post">
                                <li><i class="fas fa-calendar-day"></i><span>08 Nov, 2022</span>
                                </li>
                            ...
                            <div class="entry-content">
                                <p>In an interview with East Idaho News today, Melalecua CEO Frank Vandersloot promised
                                    to resign his executive position with the company if his world record rowing att...
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    <section class="faq-section padding-top padding-bottom section-bg">
        <div class="container">
            <div class="section-header">
                ...
                <p>We always care for our clients, we have tried to answer some frequent questions about your business
                </p>
            </div>
            <div class="row mb--20">
                <div class="col-lg-12">
                    <div class="faq-wrapper style-two">
                        <div class="faq-item">
                            ...
                            <div class="faq-content">
                                <p>The binary MLM plan is defined as a compensation plan that consists of two legs (left
                                    &amp;amp; right) or subtrees under every distributor. Upon adding subtrees, a binary
                                    tree gets formed. New members joining after them are spilled over to the downlines
                                    or next business level.</p>
                            </div>
                        </div>
                        <div class="faq-item">
                            <div class="faq-title">
                            ...
                            <div class="faq-content">
                                <p>Binary MLM plan is a network marketing compensation strategy used by many
                                    top-performing MLM companies. The new members sponsored by distributors are added
                                    either on the left or right leg. Upon adding two new members on either side of the
                                    subtree, a binary tree gets formed.

                                    All the new members referred after forming a binary tree gets spilled to the
                                    downlines.

                                    Note: Distributors become a part of the binary plan by purchasing an enrollment
                                    package. The enrollment package here means either a service or a list of products.
                                    The distributor buys the package and becomes a part of the binary MLM company.</p>
                            </div>
                        </div>
                        <div class="faq-item">
                            <div class="faq-title">
                            ...
                            <div class="faq-content">
                                <p>Unlimited depth: Binary plan allows distributors to add members to unlimited levels
                                    and earn a high income.

                                    Group work: With left leg or right spilling preferences, the distributors become
                                    active as they have to balance the tree for compensations.

                                    Quick growth: Binary plan offers quick business growth opportunities.

                                    Carry forward: Unpaid sales volume (SV) after present binary payout cycle is carry
                                    forward for the next binary payout cycle.

                                    Spillover: New members after completing the first level is spilled over to the
                                    unlimited down line levels.</p>
                            </div>
                        </div>
                        <div class="faq-item">
                            <div class="faq-title">
                            ...
                            <div class="faq-content">
                                <p>The processing time for your withdrawal will vary depending on your payment method.
                                    You can view further information on withdrawal clearance times by visiting our
                                    Payment Method page. If you are unable to locate your withdrawal after the
                                    processing time has passed, please Contact Us.</p>
                            </div>
                        </div>
                        <div class="faq-item">
                            <div class="faq-title">
                            ...
                            <div class="faq-content">
                                <p>You can make a withdrawal from the Withdraw page. Where possible we are required to
                                    send funds back to the payment method that was used to deposit the original funds.
                                    For further details relating to processing times and any applicable fees, please
                                    refer to the Withdrawals section of our Payments page.
                                    You can make a withdrawal from the Withdraw page. Where possible we are required to
                                    send funds back to the payment method that was used to deposit the original funds.
                                    For further details relating to processing times and any applicable fees, please
                                    refer to the Withdrawals section of our Payments page.</p>
                            </div>
                        </div>
                    </div>
                </div>
