                            ...
                            <div class="table-responsive--md table-responsive">
                                <table class="table--light style--two table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <span class="fw-bold">John Obodo</span>
                                                <br>
                                                <span class="small">
                                                    <a
                                                        href="https://script.viserlab.com/mlmlab/admin/users/detail/481"><span>@</span>john123</a>
                                                </span>
                                            </td>
                                            ...
                                            <td>
                                                2023-09-21 08:00 PM <br> 2 months ago
                                            </td>
                                            ...
                                            <td>
                                                <div class="button--group">
                                                    <a href="https://script.viserlab.com/mlmlab/admin/users/detail/481"
                                                        class="btn btn-sm btn-outline--primary">
                                                        <i class="las la-desktop"></i> Details </a>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <span class="fw-bold">Sushant Kumar Roa</span>
                                                <br>
                                                <span class="small">
                                                    <a
                                                        href="https://script.viserlab.com/mlmlab/admin/users/detail/477"><span>@</span>candidate</a>
                                                </span>
                                            </td>
                                            ...
                                            <td>
                                                2023-09-18 11:38 AM <br> 2 months ago
                                            </td>
                                            ...
                                            <td>
                                                <div class="button--group">
                                                    <a href="https://script.viserlab.com/mlmlab/admin/users/detail/477"
                                                        class="btn btn-sm btn-outline--primary">
                                                        <i class="las la-desktop"></i> Details </a>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <span class="small">
                                                    <a
                                                        href="https://script.viserlab.com/mlmlab/admin/users/detail/456"><span>@</span>xyabzc</a>
                                                </span>
                                            </td>
                                            ...
                                            <td>
                                                2023-09-07 03:39 PM <br> 2 months ago
                                            </td>
                                            ...
                                            <td>
                                                <div class="button--group">
                                                    <a href="https://script.viserlab.com/mlmlab/admin/users/detail/456"
                                                        class="btn btn-sm btn-outline--primary">
                                                        <i class="las la-desktop"></i> Details </a>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                2023-09-07 03:27 PM <br> 2 months ago
                                            </td>
                                            ...
                                            <td>
                                                <div class="button--group">
                                                    <a href="https://script.viserlab.com/mlmlab/admin/users/detail/454"
                                                        class="btn btn-sm btn-outline--primary">
                                                        <i class="las la-desktop"></i> Details </a>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <span class="small">
                                                    <a
                                                        href="https://script.viserlab.com/mlmlab/admin/users/detail/453"><span>@</span>xyzabc</a>
                                                </span>
                                            </td>
                                            ...
                                            <td>
                                                2023-09-07 03:07 PM <br> 2 months ago
                                            </td>
                                            ...
                                            <td>
                                                <div class="button--group">
                                                    <a href="https://script.viserlab.com/mlmlab/admin/users/detail/453"
                                                        class="btn btn-sm btn-outline--primary">
                                                        <i class="las la-desktop"></i> Details </a>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                2023-09-05 08:17 PM <br> 2 months ago
                                            </td>
                                            ...
                                            <td>
                                                <div class="button--group">
                                                    <a href="https://script.viserlab.com/mlmlab/admin/users/detail/448"
                                                        class="btn btn-sm btn-outline--primary">
                                                        <i class="las la-desktop"></i> Details </a>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="fw-bold" title="Brazil">BR</span>
                                            </td>

                                            <td>
                                                2023-09-03 09:51 PM <br> 2 months ago
                                            </td>
                                            ...
                                            <td>
                                                <div class="button--group">
                                                    <a href="https://script.viserlab.com/mlmlab/admin/users/detail/444"
                                                        class="btn btn-sm btn-outline--primary">
                                                        <i class="las la-desktop"></i> Details </a>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                2023-08-24 03:56 PM <br> 2 months ago
                                            </td>
                                            ...
                                            <td>
                                                <div class="button--group">
                                                    <a href="https://script.viserlab.com/mlmlab/admin/users/detail/426"
                                                        class="btn btn-sm btn-outline--primary">
                                                        <i class="las la-desktop"></i> Details </a>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                2023-08-09 08:55 PM <br> 3 months ago
                                            </td>
                                            ...
                                            <td>
                                                <div class="button--group">
                                                    <a href="https://script.viserlab.com/mlmlab/admin/users/detail/400"
                                                        class="btn btn-sm btn-outline--primary">
                                                        <i class="las la-desktop"></i> Details </a>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="fw-bold" title="Reunion">RE</span>
                                            </td>

                                            <td>
                                                2023-07-17 11:17 PM <br> 4 months ago
                                            </td>
                                            ...
                                            <td>
                                                <div class="button--group">
                                                    <a href="https://script.viserlab.com/mlmlab/admin/users/detail/353"
                                                        class="btn btn-sm btn-outline--primary">
                                                        <i class="las la-desktop"></i> Details </a>
                                                </div>
                                            </td>
                            ...
                            <nav>
                                <ul class="pagination">
                                    ...
                                    <li class="page-item"><a class="page-link"
                                            href="https://script.viserlab.com/mlmlab/admin/users/with-balance?page=2">2</a>
                                    </li>
                                    <li class="page-item"><a class="page-link"
                                            href="https://script.viserlab.com/mlmlab/admin/users/with-balance?page=3">3</a>
                                    </li>


                                    <li class="page-item">
                                        <a class="page-link"
                                            href="https://script.viserlab.com/mlmlab/admin/users/with-balance?page=2"
