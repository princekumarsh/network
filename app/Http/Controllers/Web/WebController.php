...
class WebController extends Controller
{
    ...
    // controllers by prince
    public function home1(){
        return view('web-views2.home');
    }
    public function about(){
        return view('web-views2.about');
    }
    public function marketing_tool(){
        return view('web-views2.marketing-tool');
    }
    public function plan(){
        return view('web-views2.plan');
    }
    public function blog(){
        return view('web-views2.blog');
    }
    public function contact(){
        return view('web-views2.contact');
    }
    public function dashboard(){
        return view('web-views2.user.dashboard');
    }
    public function blog1(){
        return view('web-views2.blog1');
    }
    public function login(){
        return view('web-views2.login');
    }
    public function register(){
        return view('web-views2.register');
    }
    public function dashboard_plan(){
        return view('web-views2.user.dashboard-plan');
    }
    public function dashboard_bvlog(){
        return view('web-views2.user.dashboard-bvlog');
    }
    public function dashboard_referral(){
        return view('web-views2.user.dashboard-referral');
    }
    public function dashboard_tree(){
        return view('web-views2.user.dashboard-tree');
    }
    public function dashboard_deposit(){
        return view('web-views2.user.dashboard-deposit');
    }
    public function dashboard_withdraw(){
        return view('web-views2.user.dashboard-withdraw');
    }
    public function dashboard_ePinRecharge(){
        return view('web-views2.user.dashboard-e-pin-recharge');
    }
    public function dashboard_transaction(){
        return view('web-views2.user.dashboard-transaction');
    }
    public function dashboard_ranking(){
        return view('web-views2.user.dashboard-ranking');
    }
    public function dashboard_ticket(){
        return view('web-views2.user.dashboard-ticket');
    }
    public function dashboard_ticket_new(){
        return view('web-views2.user.dashboard-ticket-new');
    }
    public function dashboard_ticket_view(){
        return view('web-views2.user.dashboard-ticket-view');
    }
    public function dashboard_profile_setting(){
        return view('web-views2.user.dashboard-profile-setting');
    }
